...
function main() {
  ...
  names.splice(names.indexOf("decoder_acceptance_v1.json"), 0, "dynamics/linear_query_lower_bound.js", "benchmark_v3_2.json", "benchmark_v3_2_results.json", "RELEASE_NOTES_v3_2.md", "RESEARCH_REFLECTION_v3_2.md");
